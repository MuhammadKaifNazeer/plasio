  ...
  return (
    <div className="grid min-h-screen w-full max-w-screen">
      <div className="flex flex-col">
        {/* <div className="w-100 h-[10rem] bg-gradient-to-r from-orange-600 via-orange-500 to-orange-600 rounded m-4 mb-0"></div> */}

        <main className="flex flex-col gap-4 p-4 md:gap-8 ">
          {/* <div className="flex itmes-center justify-between mb-0">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5 gap-4">
            <Dialog>
              ...
              <DialogContent className="sm:max-w-[425px] rounded-none">
                <DialogHeader>
                  <h3 className="text-lg font-semibold text-start">Meeting Notes</h3>
                </DialogHeader>
